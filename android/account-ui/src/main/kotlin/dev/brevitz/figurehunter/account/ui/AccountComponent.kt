...
import dev.brevitz.figurehunter.account.data.AccountRepositoryModule
...
@FeatureScope
@Component(dependencies = [CoreComponent::class], modules = [AccountModule::class, AccountRepositoryModule::class])
